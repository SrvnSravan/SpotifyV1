  ...
  return (
    <LinearGradient colors={['#040306', '#131624']} style={{flex: 1}}>
      ...
      <Text style={styles.freeTrialText}>FREE TRIAL</Text>
        ...
        <View >
        <Text style={styles.descriptionText}>From $49/month after. Offer only for users who are new to Premium.<Text style={styles.descriptionText2}>Terms and conditions apply.</Text></Text>
        </View>
      </View>
      <PremiumCard heading={'Why join Premium?'}
      ...
      title={'Mini'}
      title1={'From $49'}
      description={'1 day and 1 week plans . Ad-free music on mobile . Download 30 songs on 1 mobile device . Mobile only plan'}
...
<PlanCard backgroundColor={'purple'}
      title={'Duo'}
      title1={'Free'}
      description={'2 Premium accounts . For couples who live together . Ad-free music listening . Download 10,000 songs/devices, on up to 5 devices per account . Choose 1,3,6 or 12 months of Premium . Debit and credit cards accepted'}
      description1={'Offer only for users who are new to Premium.'}
      description2={'Terms and conditions apply'} />
